...
RUN apt-get update -y && DEBIAN_FRONTEND=noninteractive apt-get -qq install -y python3.8-dev python3-pip libjansson-dev libmagic-dev p7zip-full p7zip-rar nano git automake libtool make gcc pkg-config flex bison
